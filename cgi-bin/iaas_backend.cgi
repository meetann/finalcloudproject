...
if  os_name == "RedHat"  :
	...
	print commands.getoutput('sudo  virt-install  --name '+os_name+' --ram '+os_ram+' --vcpu '+os_cpu+' --disk path=/var/lib/libvirt/images/'+os_name+'.qcow2  --import  --noautoconsole --graphics=vnc,listen=192.168.43.14,port=5952,password=redhat')
	
	print os.system('sudo websockify -D --web=/usr/share/novnc 6222 192.168.43.14:5952 ')

	print commands.getoutput('sudo qr "192.168.43.14:6222" > /var/www/html/images/'+os_name+'.png ')
